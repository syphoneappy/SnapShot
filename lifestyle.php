...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js"></script>
  ...
  <body>
    ...
    <h1 class="display-2 text-center text-light" style="background:#0d0d0d; margin:0px">lifestyle</h1>
    <table>
    <?php
    $con=mysqli_connect("localhost","root","","photo");
      $id=$_SESSION["idd"];
      $r=mysqli_query($con,"select category,pname,Title,id from add_gallary where category='lifestyle'");
      $count=0;
      while($row=mysqli_fetch_array($r))
      {
        if($count%5==0)
